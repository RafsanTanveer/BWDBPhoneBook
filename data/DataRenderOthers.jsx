...
const DataRenderOthers = ({ designation, url, desig_code, tablename }) => {
    ...
    const fetchDataFromDb = async () => {
        __DEV__ && console.log('in fetchDataFromDbmmmmmmmmmfffffffffmmmmmmm');
        setIsLoading(true);
...
export default DataRenderOthers